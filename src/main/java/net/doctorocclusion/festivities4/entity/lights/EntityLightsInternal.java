...
public class EntityLightsInternal extends Entity
{
	...
	public EntityLightsInternal(World world, BlockPos pos)
	{
		this(world);
		this.noClip = true;
	...
	{
		this.getDataWatcher().updateObject(8, Integer.valueOf(color));
	}
